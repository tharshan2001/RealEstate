      ...
      <main className="pt-0">
        ...
        <section className="relative h-[70vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <span className="text-on-primary font-label uppercase tracking-[0.3em] text-sm mb-4 md:mb-6 block">Our Story</span>
            <h1 className="text-on-primary text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-headline leading-tight mb-6 md:mb-8">
              The Soul <span className="italic font-light">of the</span> North
            </h1>
            <p className="text-on-primary/90 text-base md:text-xl max-w-2xl mx-auto font-body leading-relaxed">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
            <span className="material-symbols-outlined text-on-primary text-3xl">keyboard_double_arrow_down</span>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 lg:py-32 px-4 md:px-8 bg-surface">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center">
            <div className="lg:col-span-7 bawa-frame-offset">
              <img 
            ...
            <div className="lg:col-span-5">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-headline text-primary mb-6 md:mb-8 leading-tight">The Northern Legacy</h2>
              <div className="space-y-4 md:space-y-6 text-on-surface-variant leading-relaxed font-body">
                ...
                <p className="text-tertiary-fixed-variant font-semibold">Tropical Modernism is our language; the landscape is our canvas.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 lg:py-24 px-4 md:px-8 bg-surface-container-low">
          <div className="max-w-7xl mx-auto">
            <div className="mb-10 md:mb-14 text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-headline text-primary mb-4 md:mb-6">Our Mission</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-surface-container-lowest p-6 md:p-8 lg:p-10 rounded-xl transition-transform hover:-translate-y-2 duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-headline text-primary mb-3 md:mb-4">Sustainable Development</h3>
              ...
              <div className="bg-surface-container-lowest p-6 md:p-8 lg:p-10 rounded-xl transition-transform hover:-translate-y-2 duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-headline text-primary mb-3 md:mb-4">Heritage Conservation</h3>
              ...
              <div className="bg-surface-container-lowest p-6 md:p-8 lg:p-10 rounded-xl transition-transform hover:-translate-y-2 duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-headline text-primary mb-3 md:mb-4">Investment Potential</h3>
        ...
        <section className="py-16 md:py-24 lg:py-32 px-4 md:px-8 bg-surface overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-headline text-primary mb-6 md:mb-8">Dialogue between Land and Architecture</h2>
              ...
              <ul className="space-y-4 md:space-y-6">
                <li class="flex items-start gap-3 md:gap-4">
                  <span class="w-10 md:w-12 h-10 md:h-12 rounded-full bg-secondary-container flex items-center justify-center shrink-0">
                    <span class="material-symbols-outlined text-on-secondary-container text-lg md:text-xl">foundation</span>
                  </span>
                  <div>
                    <h4 class="font-bold text-primary text-sm md:text-base">Structural Sincerity</h4>
                    <p class="text-on-surface-variant text-sm">Honest expression of materials—concrete, wood, and stone.</p>
                  </div>
                </li>
                <li class="flex items-start gap-3 md:gap-4">
                  <span class="w-10 md:w-12 h-10 md:h-12 rounded-full bg-secondary-container flex items-center justify-center shrink-0">
                    <span class="material-symbols-outlined text-on-secondary-container text-lg md:text-xl">wb_sunny</span>
                  </span>
                  <div>
                    <h4 class="font-bold text-primary text-sm md:text-base">Light and Shade</h4>
                    <p class="text-on-surface-variant text-sm">Dramatic play of shadows through curated pergolas and screens.</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-16 md:py-24 lg:py-32 px-4 md:px-8 bg-surface">
          <div className="max-w-3xl mx-auto bg-primary rounded-2xl p-8 md:p-12 lg:p-16 text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-48 md:w-64 h-48 md:h-64 bg-secondary/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
            <h2 className="text-on-primary text-3xl md:text-4xl lg:text-5xl font-headline mb-6 md:mb-8 relative z-10">Ready to Join the Legacy?</h2>
            <p className="text-on-primary/80 text-base md:text-lg mb-8 md:mb-10 max-w-xl mx-auto relative z-10">Our consultants are ready to walk you through the heritage and potential of the Northern estates.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 relative z-10">
              <Link 
                to="/lands"
                className="bg-secondary text-on-secondary px-8 md:px-10 py-3 md:py-4 rounded-full font-label text-sm uppercase tracking-widest hover:scale-105 transition-transform duration-300"
              >
                Explore the Estates
              </Link>
              <Link 
                to="/blog"
                className="border border-on-primary/30 text-on-primary px-8 md:px-10 py-3 md:py-4 rounded-full font-label text-sm uppercase tracking-widest hover:bg-on-primary/10 transition-colors"
              >
                Contact Us
              </Link>
            </div>
